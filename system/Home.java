...
public class Home extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
        ...
        public Home() {
            ...
            ImageIcon i16  = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/info.png"));
            ...
            Image i21 = i20.getImage().getScaledInstance(100, 100, Image.SCALE_DEFAULT);
            ImageIcon i23 = new ImageIcon(i21);
            JLabel l11 = new JLabel(i23);
            l11.setBounds(70, 35, 100, 100);
            add(l11);
