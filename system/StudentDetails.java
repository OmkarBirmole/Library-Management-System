...
public class StudentDetails extends JFrame implements ActionListener{
	...
	scrollPane.setBounds(50, 133, 771, 288);
	...
	ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/search.png"));
        ...
        b2.setIcon(i6);
	b2.setForeground(new Color(10, 89, 175));
	b2.setFont(new Font("Trebuchet MS", Font.BOLD, 18));
	b2.setBorder(new LineBorder(new Color(57, 55, 55), 2, true));
	b2.setBounds(662, 89, 138, 33);
	contentPane.add(b2);

		JLabel l1 = new JLabel("Student Details");
		l1.setForeground(new Color(10, 36, 175));
		l1.setFont(new Font("Osward", Font.BOLD, 38));
		l1.setBounds(50, 0, 400, 47);
		contentPane.add(l1);


	search = new JTextField();
	search.setBackground(new Color(227, 239, 251));
	search.setBorder(new LineBorder(new Color(10, 89, 175), 2, true));
